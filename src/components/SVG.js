...
// 	 width={props.width} height={props.height} viewBox="0 0 100 100" enableBackground="new 0 0 100 100" >
// <path fillRule="evenodd" clipRule="evenodd" d="M43.945,65.639c-8.835,0-15.998-7.162-15.998-15.998
...
const SVG = ({ icon, size }) => {
	return (
	<svg className={`icon-${icon}`} fill={"black"} width={size} height={size}>
